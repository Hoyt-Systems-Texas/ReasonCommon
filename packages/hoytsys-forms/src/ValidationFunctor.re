...
module StringValidation = {
  ...
  let errors = (t: Validation.StringValidation.t) =>
  ...
  let makeDefaultFieldSize =
      (
        ~required=false,
        ~maxLength=100,
        ~initialValue=(None: option(string)),
        ~name: string,
        (),
      ) => {
    make(
...
module PostalCodeValidation = {
  ...
  let errors = (t: Validation.PostalCodeValidation.t) =>
    t.baseValidation.validation.errors;
  let update = (t, value) =>
    Validation.PostalCodeValidation.validate(t, value);
  let clean = (t: Validation.PostalCodeValidation.t) => t.clean;
  let make = Validation.PostalCodeValidation.make;

  let makeDefault =
      (~required=false, ~initialValue=(None: option(string)), ~name, ()) => {
    make(~name, ~initialValue, ~required=genRequired(name, required));
  };
};
...
module FloatValidation = {
  ...
  let errors = (t: Validation.FloatValidation.t) =>
    t.baseValidation.validation.errors;
  ...
  let makeDefaultGeo =
      (~required=false, ~initialValue=(None: option(float)), ~name, ()) => {
    make(
      ~name,
      ~required=genRequired(name, required),
      ~initialValue,
...
module PhoneNumberValidation = {
  ...
  let errors = (t: Validation.PhoneNumberValidation.t) =>
    t.baseValidation.validation.errors;
  let update = (t, value) =>
    Validation.PhoneNumberValidation.validate(t, value);
  ...
  let makeDefault =
      (~required=false, ~initialValue=(None: option(string)), ~name, ()) => {
    make(~name, ~required=genRequired(name, required), ~initialValue);
  };
};
...
module IntValidation = {
  ...
  let errors = (t: Validation.IntValidation.t) =>
    t.baseValidation.validation.errors;
...
module UrlValidation = {
  ...
  let errors = (t: Validation.UrlValidation.t) =>
    t.baseValidation.validation.errors;
...
module EmailValidation = {
  ...
  let errors = (t: Validation.EmailValidation.t) =>
    t.baseValidation.validation.errors;
...
module EnumerateValidation = {
  ...
  let update = (t, value) =>
    Validation.EnumerateValueValidation.validate(t, value);
